...
func DetectHost() (host Host, rev int, err error) {
	...
	default:
		return HostNull, 0, fmt.Errorf(`embd: your host "%v:%v" is not supported at this moment. request support at https://github.com/gavincabbage/embd/issues`, host, model)
	}
}
