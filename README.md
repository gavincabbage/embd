# embd [![Build Status](https://travis-ci.org/gavincabbage/embd.svg?branch=master)](https://travis-ci.org/gavincabbage/embd) [![GoDoc](http://godoc.org/github.com/gavincabbage/embd?status.png)](http://godoc.org/github.com/gavincabbage/embd)
...
Also, you might be interested in: [Why Golang?](https://github.com/gavincabbage/embd/wiki/Why-Go)

[Blog post introducing EMBD](http://gavincabbage.io/framework/embd.html)
...
* This sample program is optimized for brevity and does not clean up after itself. Click here to see the [full version](https://github.com/gavincabbage/embd/blob/master/samples/fullblinker.go)
...
Although samples are all present in the [samples](https://github.com/gavincabbage/embd/tree/master/samples) folder,
...
* **Digital GPIO** [Documentation](http://godoc.org/github.com/gavincabbage/embd#DigitalPin)
* **Analog GPIO** [Documentation](http://godoc.org/github.com/gavincabbage/embd#AnalogPin)
* **PWM** [Documentation](http://godoc.org/github.com/gavincabbage/embd#PWMPin)
* **I2C** [Documentation](http://godoc.org/github.com/gavincabbage/embd#I2CBus)
* **LED** [Documentation](http://godoc.org/github.com/gavincabbage/embd#LED)
* **SPI** [Documentation](http://godoc.org/github.com/gavincabbage/embd#SPIBus)

## Sensors Supported

* **TMP006** Thermopile sensor [Documentation](http://godoc.org/github.com/gavincabbage/embd/sensor/tmp006), [Datasheet](http://www.adafruit.com/datasheets/tmp006.pdf), [Userguide](http://www.adafruit.com/datasheets/tmp006ug.pdf)

* **BMP085** Barometric pressure sensor [Documentation](http://godoc.org/github.com/gavincabbage/embd/sensor/bmp085), [Datasheet](https://www.sparkfun.com/datasheets/Components/General/BST-BMP085-DS000-05.pdf)

* **BMP180** Barometric pressure sensor [Documentation](http://godoc.org/github.com/gavincabbage/embd/sensor/bmp180), [Datasheet](http://www.adafruit.com/datasheets/BST-BMP180-DS000-09.pdf)

* **LSM303** Accelerometer and magnetometer [Documentation](http://godoc.org/github.com/gavincabbage/embd/sensor/lsm303), [Datasheet](https://www.sparkfun.com/datasheets/Sensors/Magneto/LSM303%20Datasheet.pdf)

* **L3GD20** Gyroscope [Documentation](http://godoc.org/github.com/gavincabbage/embd/sensor/l3gd20), [Datasheet](http://www.adafruit.com/datasheets/L3GD20.pdf)

* **US020** Ultrasonic proximity sensor [Documentation](http://godoc.org/github.com/gavincabbage/embd/sensor/us020), [Product Page](http://www.digibay.in/sensor/object-detection-and-proximity?product_id=239)

* **BH1750FVI** Luminosity sensor [Documentation](http://godoc.org/github.com/gavincabbage/embd/sensor/bh1750fvi), [Datasheet](http://www.elechouse.com/elechouse/images/product/Digital%20light%20Sensor/bh1750fvi-e.pdf)
...
* **PCA9685** 16-channel, 12-bit PWM Controller with I2C protocol [Documentation](http://godoc.org/github.com/gavincabbage/embd/controller/pca9685), [Datasheet](http://www.adafruit.com/datasheets/PCA9685.pdf), [Product Page](http://www.adafruit.com/products/815)

* **MCP4725** 12-bit DAC [Documentation](http://godoc.org/github.com/gavincabbage/embd/controller/mcp4725), [Datasheet](http://www.adafruit.com/datasheets/mcp4725.pdf), [Product Page](http://www.adafruit.com/products/935)

* **ServoBlaster** RPi PWM/PCM based PWM controller [Documentation](http://godoc.org/github.com/gavincabbage/embd/controller/servoblaster), [Product Page](https://github.com/richardghirst/PiBits/tree/master/ServoBlaster)
...
We look forward to your pull requests, but contributions which abide by the [guidelines](https://github.com/gavincabbage/embd/blob/master/CONTRIBUTING.md) will get a free beer!

File an [issue](https://github.com/gavincabbage/embd/issues), open a [pull request](https://github.com/gavincabbage/embd/pulls). We are waiting.

## About

EMBD is affectionately designed/developed by Karan Misra ([gavincabbage](https://github.com/gavincabbage)), Kunal Powar ([kunalpowar](https://github.com/kunalpowar)) and [FRIENDS](https://github.com/gavincabbage/embd/blob/master/AUTHORS). We also have a list of [CONTRIBUTORS](https://github.com/gavincabbage/embd/blob/master/CONTRIBUTORS).
